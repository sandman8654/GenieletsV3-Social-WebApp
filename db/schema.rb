...
ActiveRecord::Schema.define(version: 20150611035440) do
  ...
  create_table "private_payments", force: true do |t|
    t.integer  "user_id"
    t.integer  "property_id"
    t.decimal  "amount",      precision: 5, scale: 2
    t.date     "date_paid"
  ...
  create_table "properties", force: true do |t|
    ...
    t.decimal  "rental",        precision: 10, scale: 0
    t.text     "notes"
    t.string   "address1"
    t.string   "address2"
    t.string   "address3"
  ...
  create_table "users", force: true do |t|
    ...
    t.integer  "contract_max_count",     default: 5
    t.boolean  "is_active",              default: true
    t.string   "subscription_type",      default: "Trial"
    t.date     "subscribed_date"
    t.integer  "contract_count",         default: 0
